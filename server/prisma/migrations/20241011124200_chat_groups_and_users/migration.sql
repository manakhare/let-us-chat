...
-- AddForeignKey
ALTER TABLE "ChatGroupUsers" ADD CONSTRAINT "ChatGroupUsers_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "chat_groups"("id") ON DELETE CASCADE ON UPDATE CASCADE;
